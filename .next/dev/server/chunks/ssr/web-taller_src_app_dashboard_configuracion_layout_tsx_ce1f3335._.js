module.exports = [
"[project]/web-taller/src/app/dashboard/configuracion/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function ConfiguracionLayout({ children }) {
    ...
    //   .eq("id", user.id)
    //   .single()
    const { data: profile, error } = await supabase.from("profiles").select("rol").eq("id", user.id).single();
...
//# sourceMappingURL=web-taller_src_app_dashboard_configuracion_layout_tsx_ce1f3335._.js.map