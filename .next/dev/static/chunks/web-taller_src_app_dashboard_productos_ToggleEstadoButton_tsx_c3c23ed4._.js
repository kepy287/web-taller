...
"[project]/web-taller/src/app/dashboard/productos/ToggleEstadoButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ToggleEstadoButton({ id, estado }) {
    _s();
    ...
    const handleToggle = async ()=>{
        const confirmacion = confirm(estado ? "¿Deseas desactivar este producto?" : "¿Deseas activar este producto?");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$web$2d$taller$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        ...
        className: `transition-colors ${estado ? "text-[#8698b3] hover:text-red-500" : "text-[#8698b3] hover:text-green-500"}`,
        children: estado ? "Desactivar" : "Activar"
    }, void 0, false, {
        fileName: "[project]/web-taller/src/app/dashboard/productos/ToggleEstadoButton.tsx",
        lineNumber: 43,
        columnNumber: 5
    }, this);
}
_s(ToggleEstadoButton, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
...
_c = ToggleEstadoButton;
var _c;
__turbopack_context__.k.register(_c, "ToggleEstadoButton");
...
//# sourceMappingURL=web-taller_src_app_dashboard_productos_ToggleEstadoButton_tsx_c3c23ed4._.js.map